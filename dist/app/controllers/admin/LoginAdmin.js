...
const LoginAdmin = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isAdminExist = yield AdminModel_1.default.isUserExist(phoneNumber);
    if (!isAdminExist)
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'Admin does not exist');
    // checking is password valid
    if (isAdminExist.password && !(yield AdminModel_1.default.isPasswordMatched(password, isAdminExist.password))) {
